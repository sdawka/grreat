...
import { validateEmail, createSignupResponse, handleSignupWithDB, type Env } from '../../lib/signup';
      ...
      return createSignupResponse(
        {
          success: false,
          error:
            'Waitlist database is not configured. To set up locally: create a D1 database with `npx wrangler d1 create grreat-waitlist`, update wrangler.toml with the database_id, and run migrations.',
        },
        503,
      );
    }
